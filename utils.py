...
def create_estimator(opt):
    ...
    estimator = network.MaskEstimator(opt)
    print('Estimator is created!')
    network.weights_init(estimator, init_type = opt.init_type, init_gain = opt.init_gain)
    print('Initialize estimator with %s type' % opt.init_type)
    return estimator
